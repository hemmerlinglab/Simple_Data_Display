""" Original version which saves the csv files, and plots them includes modifications by john which has vertical lines and calculates the difference between the spectral lines  """
import numpy as np
import matplotlib
