...
def get_reduced_dunham():
    ...
    # ground state from Bernath
    Ug = [
            [0.,3.703932569,-0.00004535350083],
            [1880.20433],
            [-32.01271]
            ]
    ...
    # excited state
    Ue = [
           [38255.41088,3.710086911,0.002721267262],
           [1736.170635]
         ]
    ...
    ## ground state from Bernath
    #Ug = [
    #        [0.0, 3.688196398, -0.021311],
    #        [1880.165]
    #        ]
    #
    ## excited state
    #Ue = [
    #       [38254.92428, 3.65372, -0.0902331],
    #       [1744.076512]
    #     ]
...
def read_in_data(data, offset_avg = 10, datafolder = '/Users/boerge/Software/offline_data/', moving_avg_no = 0):
    ...
    times = np.linspace(0, t_steps * t_count, t_count)
