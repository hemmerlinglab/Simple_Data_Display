...
def data2losalamos(data, save_filename = 'data_lines.txt', add_q = False, q_lines = []):
...
def predict_lines(Ug, Ue, save_filename = 'line_predictions.txt', vg = 0, ve = 0, Jmax = 10):
...
def fcn2min_multi(params, x, data, func = None, plot_fit = False):
